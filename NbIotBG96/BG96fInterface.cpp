...
void BG96Interface::enablePowerSavingMode()
{
	_BG96.enablePowerSavingMode();
}


void BG96Interface::pwrOn()
{
	_BG96.pwrOn();
}


void BG96Interface::send_at(char str[], bool printEnabled)
{
	_BG96.send_at(str, printEnabled);
}